#!/usr/bin/env python3
"""
Скрипт для генерации нового OAuth токена для Google API через консоль.
...
def main():
    ...
    try:
        ...
        # Запускаем авторизацию через консоль (без браузера)
        print("🔄 Запуск авторизации через консоль...")
        print("Пожалуйста, войдите в аккаунт Google (vipzerocoder@gmail.com)")
        print("и разрешите доступ к Google Drive и Google Sheets")
        print()
